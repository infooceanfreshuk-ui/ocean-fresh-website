      ...
      <div className="absolute bottom-0 w-full min-h-[100svh] flex items-center justify-center z-10 pointer-events-none pb-16">
        <div className="container mx-auto px-4 md:px-6 pointer-events-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Content Card - Removed backdrop-blur as it causes massive scroll lag on many devices */}
            <div className="bg-white/95 rounded-[3rem] p-8 md:p-12 shadow-2xl border border-white/20">
              <div className="space-y-8">
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <Link href="/export">
                    <Button size="lg" variant="outline" className="rounded-full text-base gap-2 group border-ocean-200 hover:bg-ocean-50 transition-colors">
                      Discover MAP
                    </Button>
                  </Link>
                </div>
